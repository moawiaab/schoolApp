...
class SessionManager extends \SessionHandler 
{
    ...
    private $sessionMaxLiftime = SESSION_LIFE_TIME;
    ...
    {
        $this->sessionSSL = isset($_SESSION['HTTPS']) ? true : false;
        //$this->sessionDomain = str_replace('www.', '', $_SESSION['SERVER_NAME']);
        ...
        session_set_cookie_params(
            $this->sessionMaxLiftime,$this->sessionPath,
    ...
    public function __get($key)
    {
        if(isset($_SESSION[$key])){
            ...
            trigger_error('N session key' . $key . ' exists', E_USER_NOTICE);
        }
    ...
    {
         $userAgentId = $_SESSION['HTTP_USER_ANGEN'];
    ...
    public function isValidFingerPrint()
    {
        ...
        $fingerPrint = md5($_SESSION['HTTP_USER_ANGEN'] . $this->cipherKey . session_id());
